...
with col2:
    ...
    if uploaded_file is None:
        ...
        <div class="upload-zone">
            ...
            <p class="upload-text">Drag and drop your KMZ file here</p>
            <p class="upload-hint">or click to browse • Max {max_size}MB</p>
        </div>
        """.format(max_size=config.MAX_FILE_SIZE_MB), unsafe_allow_html=True)
    else:
        st.markdown(f"""
        <div class="info-card" style="text-align: center;">
            <p style="margin: 0; font-weight: 600; color: #1A1A1A;">✅ {uploaded_file.name}</p>
            <p style="margin: 0.5rem 0 0 0; font-size: 0.85rem; color: #6B7280;">
                {uploaded_file.size / 1024:.1f} KB • Ready to analyze
            </p>
        </div>
        """, unsafe_allow_html=True)
...
# ============================================================================
# LOG SECTION (Discreet, at bottom)
# ============================================================================
st.markdown("<br>", unsafe_allow_html=True)
with st.expander("📋 Processing Log", expanded=False):
    ...
    if all_messages:
        ...
        st.caption("Log will appear here once processing starts.")
